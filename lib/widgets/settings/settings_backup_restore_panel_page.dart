...
class SettingsBackupRestorePanelPage extends StatelessWidget {
  ...
  final backupRestoreService = new BackupRestoreService();
              ...
              if (await backupRestoreService.settingsBackup()) {
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      content: new Text("FLauncher settings backup successfully created and stored in your Download folder"),
                      actions: <Widget>[
                        new FlatButton(
                          child: new Text("OK"),
                          onPressed: () {
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      content: new Text("Failed to backup FLauncher settings"),
                      actions: <Widget>[
                        new FlatButton(
                          child: new Text("OK"),
                          onPressed: () {
            ...
            onPressed: () async {
              if (await backupRestoreService.settingsRestore()) {
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      content: new Text("FLauncher settings successfully restored from backup. FLauncher will be restarted now."),
                      actions: <Widget>[
                        new FlatButton(
                          child: new Text("OK"),
                          onPressed: () {
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      content: new Text("Failed to restore FLauncher settings from backup"),
                      actions: <Widget>[
                        new FlatButton(
                          child: new Text("OK"),
                          onPressed: () {
