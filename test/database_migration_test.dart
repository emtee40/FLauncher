...
void main() {
  ...
  test("upgrade from v1 to v6", () async {
    ...
    expect(category.nameHidden, false);
  ...
  test("upgrade from v5 to v6", () async {
    ...
    await oldDb.into(oldDb.appsCategories).insert(
          v5.AppsCategoriesCompanion.insert(categoryId: categoryId, appPackageName: "me.efesser.flauncher", order: 0),
        );
    await oldDb.close();
